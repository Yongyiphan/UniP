...
// declarations ...
namespace {
void Dump(HLP2::WarBoats::Ocean const& ocean, int field_width = 4,  bool extraline = false, bool showboats = true);
...
namespace {
void Dump(const HLP2::WarBoats::Ocean &ocean, int field_width, bool extraline, bool showboats) {
